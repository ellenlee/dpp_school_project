	...
	<section id="content" class="widecol alignleft">
		...
		<div class="slider-wrapper theme-default">
			<div id="slider" class="nivoSlider">
				<?php $grasstw_slider_param = array (
					'post_type' => 'slider_img',
					// 'cat' => '13',/* This number needs to change based on your theme */
					'post_count' => '5',
				);

				$the_query = new WP_Query( $grasstw_slider_param );

				if ( $the_query->have_posts() ) : while ( $the_query->have_posts() ) : $the_query->the_post(); ?>

					<a href="<?php $grasstw_slider_url = get_post_custom_values( 'slider_url' ); echo $grasstw_slider_url[0]; ?>" title="<?php the_title(); ?>"><?php the_post_thumbnail( 'slider' ); ?></a>
